import { EntityCategoriesResponse, EntityCategoryResponse, EntityCategoryType, EntityDreamResponse } from "../../api/generated_api"
...
const metaDream1: EntityDreamResponse = { id: 1, date: "2025-01-01T12:30:00Z", visible: true, finalized: false, description: "", categories: [cat1] }
const metaDream2: EntityDreamResponse = { id: 2, date: "2025-02-01T12:30:00Z", visible: true, finalized: true, rating: 3, description: "", categories: [pers1] }
const privateDream3: EntityDreamResponse = { id: 3, date: "2025-02-02T13:00:00Z", visible: false, finalized: false, description: "", categories: [] }
