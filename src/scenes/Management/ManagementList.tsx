...
export default function ManagementList(props: {
    ...
    return (
        <List>
            {sortedItems.map(l => (<ManagementListItem key={l.id} listItem={l} />))}
        </List>
    )
}
...
const CustomStack: React.FC<React.PropsWithChildren<CustomStackProps>> = ({ children, spacing = 1, ...stackProps }) => {
