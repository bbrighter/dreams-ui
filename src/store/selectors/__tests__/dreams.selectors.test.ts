...
describe("useFilteredDreams", () => {
  beforeEach(() => {
    ...
    setDreams([
      { id: 1, categories: [1], date: new Date(), description: "", finalized: false, visible: true, rating: null },
      { id: 2, categories: [1,2,3], date: new Date(), description: "", finalized: false, visible: true, rating: null },
    ])
  })
