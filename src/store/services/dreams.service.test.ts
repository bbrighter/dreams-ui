  ...
  describe("get dreams", () => {
    ...
    it("sorted by date", async () => {
      server.use(getDreamsHandler([
        { date: "2027-01-01T12:30:00Z", finalized: false, id: 1, visible: true, categories: [], description: "" },
        { date: "2026-01-01T12:30:00Z", finalized: false, id: 2, visible: true, categories: [], description: "" },
      ]))
      await dreamsService.getDreams()
